module.exports = class LapList {
  ...
  setListContent() {
    document.getElementById(this.elementName).innerHTML = '';
  ...
  formatLaptime(seconds) {
    ...
    const fmilliseconds = ((d.getMilliseconds() < 10) ? '00' : ((d.getMilliseconds() > 9 && d.getMilliseconds() < 100) ? '0' : '')) + d.getMilliseconds();
